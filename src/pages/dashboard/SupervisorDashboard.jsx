...
import { fetchSupervisorBehaviorOverview, acknowledgeBehaviorAlert } from '../../utils/behaviorTracker';
...
const SupervisorDashboard = () => {
  ...
  const topWorkersBarData = {
    labels: topCompliantWorkers.map((worker) => worker.user?.name || 'Worker'),
    datasets: [
      {
        label: 'Compliance Score',
        data: topCompliantWorkers.map((worker) => worker.complianceScore || 0),
      ...
      >
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <div className="space-y-4">
            {topCompliantWorkers.map((worker) => (
